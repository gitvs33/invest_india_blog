...
import { updatePageMetaTags, generatePostStructuredData, generateBlogStructuredData } from './utils/seo';
  ...
  useEffect(() => {
    ...
    if (path.startsWith('/post/')) {
      ...
      if (post) {
        ...
        let script = document.querySelector('script[data-structured-data="post"]');
        if (!script) {
          script = document.createElement('script');
          script.setAttribute('type', 'application/ld+json');
          script.setAttribute('data-structured-data', 'post');
